...
import io.github.ykwyuta.llmmock.provider.anthropic.AnthropicWire;
...
public class BedrockController {
                ...
                if (messages != null && messages.isArray()) {
                    for (JsonNode message : messages) {
                        builder.message(ChatRole.from(text(message, "role")),
                                io.github.ykwyuta.llmmock.provider.common.JsonText
    ...
    private String flattenAnthropicSystem(JsonNode system) {
        return io.github.ykwyuta.llmmock.provider.common.JsonText.flatten(system);
    }
