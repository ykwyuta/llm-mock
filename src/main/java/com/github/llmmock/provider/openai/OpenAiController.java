package com.github.llmmock.provider.openai;
...
import com.github.llmmock.core.EmbeddingGenerator;
...
import com.github.llmmock.core.TokenCounter;
import com.github.llmmock.core.ToolSpec;
import com.github.llmmock.provider.common.AuthGuard;
import com.github.llmmock.provider.common.JsonText;
import com.github.llmmock.provider.common.SseWriter;
...
public class OpenAiController {
    ...
    private void writeStream(MockRequest request, MockCompletion completion, boolean includeUsage,
        ...
        for (com.github.llmmock.core.ToolCall call : completion.toolCalls()) {
            StreamResponse.pause(delay);
