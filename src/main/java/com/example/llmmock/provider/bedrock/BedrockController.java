...
import com.example.llmmock.core.ToolCall;
import com.example.llmmock.core.ToolSpec;
import com.example.llmmock.provider.anthropic.AnthropicWire;
...
public class BedrockController {
                ...
                if (messages != null && messages.isArray()) {
                    for (JsonNode message : messages) {
                        builder.message(ChatRole.from(text(message, "role")),
                                com.example.llmmock.provider.common.JsonText
    ...
    private String flattenAnthropicSystem(JsonNode system) {
        return com.example.llmmock.provider.common.JsonText.flatten(system);
    }
